...
$selQuery = "SELECT * FROM `block` where id=$id";
$blockQuery = $con->query($selQuery);
$_slidr = mysqli_fetch_assoc($blockQuery);
?>
						...
						<div class="panel panel-info">
							<div class="panel-body">
                                ...
                                <div class="form-group">
										...
										<input class="form-control" name="identifier" type="text"  value="<?= $_slidr['identifier']?? ''; ?>">
									</div>
									...
									<div class="form-group">
										...
										<input class="form-control" name="heading" type="text" value="<?= $_slidr['heading']?? ''; ?>">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea name="description" id="" cols="30" rows="10" ><?= $_slidr['description']?? ''; ?></textarea>
									</div>
									<div class="row">
										<div class="col-md-12">
														...
														<div class="">
															<div class="fileupload fileupload-new" data-provides="fileupload">
																<div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                                                    <img src="<?= $_slidr['banner_image']?? ''; ?>" alt="">
                                                            </div>
																<div>
